...
import { useRef, useEffect, forwardRef, type ForwardRefExoticComponent, type RefAttributes } from "react";
...
const WrappedRetro = wrapEffect(RetroEffectImpl) as unknown as ForwardRefExoticComponent<
  { colorNum: number; pixelSize: number } & RefAttributes<RetroEffectImpl>
>;
...
export default function Dither({
  ...
  return (
    <Canvas
      ...
      style={enableMouseInteraction ? undefined : { pointerEvents: "none" }}
